...
###三、MySQL生产中上亿数据大表怎么在线增加一个字段并设定默认值？
**2019年07月11日，周四**
```
一、MySQL8.0版本
如果满足以下条件：
...
###四、MySQL表中有自增列id，但是表中的id列数据不连续，产生的可能原因是什么？
**2019年07月16日，周二**
```
可能的情况有如下几种：
...
###五、如何定位造成MySQL慢的罪魁祸首慢SQL及分析优化思路？
**2019年07月18日，周四**
```
一、首先需要打开慢查询
